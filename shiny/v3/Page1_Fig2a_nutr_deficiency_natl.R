...
# Read data
data <- readRDS(file.path(datadir, "nutr_deficiencies_by_cntry_sex_age_2011.Rds"))

# Test country
country <- "Ghana"

# Plot population growth data
plot_barplot_n_deficient <- function(data, country){
...
# Test function
plot_barplot_n_deficient(data=data, country="Canada")
